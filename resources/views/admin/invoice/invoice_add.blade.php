              ...
              <div class="row">
                ...
                <div class="col-md-1">
                  <div class="md-3">
                    ...
                    <input class="form-control example-date-input" name="invoice_no" type="text"
                      value="{{ $invoice_no }}" id="invoice_no" readonly style="background-color:#ddd">
                  </div>
                </div>
                ...
                <div class="col-md-2">
                  <div class="md-3">
                    ...
                    <i class="btn btn-secondary btn-rounded waves-effect waves-light fas fa-plus-circle addeventmore"> Add
                      More</i>
                  </div>
                </div>
