        ...
        <div class="col-12">
          <div class="card">
            <div class="card-body">
              ...
              <a href="{{ route('credit.customer') }}" class="btn btn-dark btn-rounded waves-effect waves-light"
                style="float:right;"><i class="fa fa-list"> Back </i></a> <br> <br>
                        ...
                        <div class="row">
                          ...
                          <div class="form-group col-md-3">
                            <div class="md-3">
                              ...
                              <input class="form-control example-date-input" placeholder="YYYY-MM-DD" name="date"
                                type="date" id="date">
                            </div>
                          </div>
