        ...
        <div class="col-12">
          <div class="card">
            <div class="card-body">
              ...
              <a href="{{ route('unit.create') }}" class="btn btn-dark btn-rounded waves-effect waves-light"
                  ...
                  @foreach ($units as $key => $item)
                    <tr>
                      ...
                      <td>
                        ...
                        <a data-id="{{ $item->id }}" href="{{ route('unit.destroy', $item->id) }}"
